...
const strings = {
 ...
 auth_sign_out:         { pt: 'Sair da conta',                      en: 'Sign out'                          },
  ...
  // ── Medals (Journey achievements) ──
  journey_medals_title:   { pt: 'Medalhas', en: 'Medals' },
  journey_medals_count:   { pt: 'conquistadas', en: 'earned' },
  medal_first_light_title:    { pt: 'Primeira Luz', en: 'First Light' },
  medal_first_light_desc:     { pt: 'Estude seu primeiro dia', en: 'Study your first day' },
  medal_gatherer_title:       { pt: 'Colhedor', en: 'Gatherer' },
  medal_gatherer_desc:        { pt: 'Salve 10 palavras', en: 'Save 10 words' },
  medal_faithful_week_title:  { pt: 'Semana Fiel', en: 'Faithful Week' },
  medal_faithful_week_desc:   { pt: '7 dias seguidos de estudo', en: '7-day study streak' },
  medal_treasurer_title:      { pt: 'Tesoureiro', en: 'Treasurer' },
  medal_treasurer_desc:       { pt: 'Salve 25 versículos', en: 'Save 25 verses' },
  medal_scribe_title:         { pt: 'Escriba', en: 'Scribe' },
  medal_scribe_desc:          { pt: 'Escreva 10 notas', en: 'Write 10 notes' },
  medal_master_10_title:      { pt: 'Dez Talentos', en: 'Ten Talents' },
  medal_master_10_desc:       { pt: 'Domine 10 palavras', en: 'Master 10 words' },
  medal_wordsmith_title:      { pt: 'Artesão da Palavra', en: 'Wordsmith' },
  medal_wordsmith_desc:       { pt: 'Salve 50 palavras', en: 'Save 50 words' },
  medal_pilgrim_title:        { pt: 'Peregrino', en: 'Pilgrim' },
  medal_pilgrim_desc:         { pt: 'Estude por 30 dias no total', en: 'Study on 30 different days' },
  medal_faithful_month_title: { pt: 'Mês Fiel', en: 'Faithful Month' },
  medal_faithful_month_desc:  { pt: '30 dias seguidos de estudo', en: '30-day study streak' },
  medal_master_50_title:      { pt: 'Boas-Vindas do Mestre', en: "Master's Welcome" },
  medal_master_50_desc:       { pt: 'Domine 50 palavras', en: 'Master 50 words' },
