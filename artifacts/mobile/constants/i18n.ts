...
const strings = {
 ...
 auth_sign_out:         { pt: 'Sair da conta',                      en: 'Sign out'                          },
  ...
  // ── Prayer Journey
  pr_title:              { pt: 'Jornada de Oração', en: 'Prayer Journey' },
  pr_subtitle:           { pt: 'Caminhe com Deus em cada oração.', en: 'Walk with God through every prayer.' },
  pr_stat_active:        { pt: 'Orações ativas', en: 'Active Prayers' },
  pr_stat_answered:      { pt: 'Respondidas', en: 'Answered Prayers' },
  pr_stat_favorites:     { pt: 'Favoritas', en: 'Favorites' },
  pr_stat_streak:        { pt: 'Sequência', en: 'Prayer Streak' },
  pr_days:               { pt: 'dias', en: 'days' },
  pr_continue:           { pt: 'Continue orando', en: 'Continue Praying' },
  pr_created_ago:        { pt: 'Criada há {n} dias', en: 'Created {n} days ago' },
  pr_created_today:      { pt: 'Criada hoje', en: 'Created today' },
  pr_segment_prayers:    { pt: 'Orações', en: 'Prayers' },
  pr_segment_memorials:  { pt: 'Memoriais', en: 'Memorials' },
  pr_search_ph:          { pt: 'Buscar por título, categoria ou versículo…', en: 'Search by title, category or verse…' },
  pr_filter_all:         { pt: 'Todas', en: 'All' },
  pr_filter_active:      { pt: 'Ativas', en: 'Active' },
  pr_filter_answered:    { pt: 'Respondidas', en: 'Answered' },
  pr_filter_favorites:   { pt: 'Favoritas', en: 'Favorites' },
  pr_filter_archived:    { pt: 'Arquivadas', en: 'Archived' },
  pr_empty_title:        { pt: 'Nenhuma oração ainda', en: 'No prayers yet' },
  pr_empty_sub:          { pt: 'Toque em + para registrar sua primeira oração e começar a caminhar com Deus.', en: 'Tap + to record your first prayer and begin walking with God.' },
  pr_empty_filtered:     { pt: 'Nada aqui com esse filtro.', en: 'Nothing here with this filter.' },
  pr_memorials_title:    { pt: 'Memoriais', en: 'Memorials' },
  pr_memorials_sub:      { pt: 'Pedras de lembrança — cada oração respondida é um memorial da fidelidade de Deus.', en: 'Stones of remembrance — every answered prayer is a memorial of God’s faithfulness.' },
  pr_memorials_empty:    { pt: 'Seus memoriais aparecerão aqui quando Deus responder suas orações.', en: 'Your memorials will appear here as God answers your prayers.' },
  pr_answered_after:     { pt: 'Respondida após {n} dias', en: 'Answered after {n} days' },
  pr_answered_same_day:  { pt: 'Respondida no mesmo dia', en: 'Answered the same day' },
  pr_new_prayer:         { pt: 'Nova oração', en: 'New Prayer' },
  pr_field_title:        { pt: 'Título da oração', en: 'Prayer Title' },
  pr_field_title_ph:     { pt: 'Ex.: Orar pelo novo emprego', en: 'e.g. Pray for my new job' },
  pr_field_desc:         { pt: 'Descrição', en: 'Description' },
  pr_field_desc_ph:      { pt: 'O que está no seu coração?', en: 'What is on your heart?' },
  pr_field_category:     { pt: 'Categoria', en: 'Category' },
  pr_field_scripture:    { pt: 'Passagem sugerida', en: 'Suggested Scripture' },
  pr_field_scripture_hint:{ pt: 'Toque para apoiar sua oração em uma passagem (opcional)', en: 'Tap to rest this prayer on a passage (optional)' },
  pr_field_reminder:     { pt: 'Lembrete', en: 'Reminder' },
  pr_reminder_none:      { pt: 'Sem lembrete', en: 'None' },
  pr_reminder_daily:     { pt: 'Diário', en: 'Daily' },
  pr_reminder_weekly:    { pt: 'Semanal', en: 'Weekly' },
  pr_field_privacy:      { pt: 'Privacidade', en: 'Privacy' },
  pr_privacy_private:    { pt: 'Só eu', en: 'Only me' },
  pr_privacy_family:     { pt: 'Família', en: 'Family' },
  pr_privacy_group:      { pt: 'Grupo de oração', en: 'Prayer Group' },
  pr_privacy_soon:       { pt: 'em breve', en: 'coming soon' },
  pr_field_favorite:     { pt: 'Marcar como favorita', en: 'Mark as favorite' },
  pr_save:               { pt: 'Guardar oração', en: 'Save Prayer' },
  pr_cancel:             { pt: 'Cancelar', en: 'Cancel' },
  pr_status_praying:     { pt: 'Orando', en: 'Praying' },
  pr_status_waiting:     { pt: 'Aguardando', en: 'Waiting' },
  pr_status_answered:    { pt: 'Respondida', en: 'Answered' },
  pr_status_archived:    { pt: 'Arquivada', en: 'Archived' },
  pr_cat_work:           { pt: 'Trabalho', en: 'Work' },
  pr_cat_health:         { pt: 'Saúde', en: 'Health' },
  pr_cat_family:         { pt: 'Família', en: 'Family' },
  pr_cat_relationships:  { pt: 'Relacionamentos', en: 'Relationships' },
  pr_cat_hope:           { pt: 'Esperança', en: 'Hope' },
  pr_cat_guidance:       { pt: 'Direção', en: 'Guidance' },
  pr_cat_provision:      { pt: 'Provisão', en: 'Provision' },
  pr_cat_gratitude:      { pt: 'Gratidão', en: 'Gratitude' },
  pr_cat_other:          { pt: 'Outro', en: 'Other' },
  pr_i_prayed:           { pt: 'Orei por isso hoje', en: 'I prayed for this today' },
  pr_prayed_done:        { pt: 'Amém — registrado.', en: 'Amen — recorded.' },
  pr_answered_q:         { pt: 'Deus respondeu esta oração?', en: 'God answered this prayer?' },
  pr_answered_yes:       { pt: 'Sim, respondeu', en: 'Yes' },
  pr_answered_how:       { pt: 'Como Deus respondeu?', en: 'How did God answer?' },
  pr_answered_how_ph:    { pt: 'Escreva seu testemunho — ele se tornará um memorial.', en: 'Write your testimony — it will become a memorial.' },
  pr_answered_save:      { pt: 'Guardar memorial', en: 'Save Memorial' },
  pr_testimony:          { pt: 'Testemunho', en: 'Testimony' },
  pr_notes:              { pt: 'Anotações', en: 'Notes' },
  pr_note_ph:            { pt: 'Adicionar uma anotação…', en: 'Add a note…' },
  pr_note_add:           { pt: 'Adicionar', en: 'Add' },
  pr_timeline:           { pt: 'Linha do tempo', en: 'Timeline' },
  pr_tl_created:         { pt: 'Oração criada', en: 'Prayer created' },
  pr_tl_prayed:          { pt: 'Momento de oração', en: 'Prayed' },
  pr_tl_note:            { pt: 'Anotação adicionada', en: 'Note added' },
  pr_tl_answered:        { pt: 'Deus respondeu', en: 'God answered' },
  pr_tl_status:          { pt: 'Status alterado', en: 'Status changed' },
  pr_detail_created:     { pt: 'Criada em', en: 'Created' },
  pr_detail_answered_on: { pt: 'Respondida em', en: 'Answered' },
  pr_detail_waiting:     { pt: 'Tempo de espera', en: 'Waiting time' },
  pr_edit:               { pt: 'Editar', en: 'Edit' },
  pr_archive:            { pt: 'Arquivar', en: 'Archive' },
  pr_unarchive:          { pt: 'Reativar', en: 'Reactivate' },
  pr_delete:             { pt: 'Excluir', en: 'Delete' },
  pr_delete_confirm_t:   { pt: 'Excluir esta oração?', en: 'Delete this prayer?' },
  pr_delete_confirm_b:   { pt: 'Isso não pode ser desfeito.', en: 'This cannot be undone.' },
  pr_share_testimony:    { pt: 'Compartilhar testemunho', en: 'Share testimony' },
  pr_share_prefix:       { pt: 'Deus respondeu esta oração após {n} dias.', en: 'God answered this prayer after {n} days.' },
  pr_share_prefix_same:  { pt: 'Deus respondeu esta oração.', en: 'God answered this prayer.' },
  pr_gentle_nudge:       { pt: 'Um momento para revisitar esta oração.', en: 'Take a moment to revisit this prayer.' },
  pr_gentle_trust:       { pt: 'Continue confiando em Deus.', en: 'Continue trusting God.' },
  pr_open_passage:       { pt: 'Abrir passagem', en: 'Open passage' },
  pr_not_found:          { pt: 'Oração não encontrada.', en: 'Prayer not found.' },
  pr_home_entry:         { pt: 'Jornada de Oração', en: 'Prayer Journey' },
  pr_home_entry_sub:     { pt: 'Lembre-se da fidelidade de Deus', en: 'Remember God’s faithfulness' },
  pr_a11y_open:          { pt: 'Abrir oração', en: 'Open prayer' },
  pr_a11y_fab:           { pt: 'Criar nova oração', en: 'Create new prayer' },
  pr_a11y_back:          { pt: 'Voltar', en: 'Back' },
