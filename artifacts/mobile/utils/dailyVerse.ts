...
export const DAILY_POOL: DailyEntry[] = [
  ...
  { bookId: 'john',         chapter: 1,  verse: 29, bookEn: 'John',          bookPt: 'João'        },
  { bookId: 'john',         chapter: 3,  verse: 16, bookEn: 'John',          bookPt: 'João'        },
  { bookId: 'john',         chapter: 3,  verse: 17, bookEn: 'John',          bookPt: 'João'        },
  { bookId: 'john',         chapter: 10, verse: 11, bookEn: 'John',          bookPt: 'João'        },
  ...
  { bookId: 'proverbs',     chapter: 16, verse: 18, bookEn: 'Proverbs',      bookPt: 'Provérbios'  },
  { bookId: 'proverbs',     chapter: 22, verse: 6,  bookEn: 'Proverbs',      bookPt: 'Provérbios'  },
